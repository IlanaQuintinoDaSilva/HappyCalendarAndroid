...
import static br.com.iq.happycalendarandroid.data.TodosContract.CONTENT_AUTHORITY;
import static br.com.iq.happycalendarandroid.data.TodosContract.PATH_CATEGORIES;
import static br.com.iq.happycalendarandroid.data.TodosContract.PATH_TODOS;
...
public class TodosProvider extends ContentProvider{
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        switch (match) {
            ...
            case CATEGORIES:
                return insertRecord(uri, contentValues, TodosContract.CategoriesEntry.TABLE_NAME);
            default:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case CATEGORIES:
                return deleteRecord(uri, null, null, TodosContract.CategoriesEntry.TABLE_NAME);
            case CATEGORIES_ID:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case CATEGORIES:
                return updateRecord(uri, values, selection, selectionArgs, TodosContract.CategoriesEntry.TABLE_NAME);
            default:
